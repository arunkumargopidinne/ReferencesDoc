...
export default function QuestionsGenerator({ startTask, updateTask, endTask }: TaskProps) {
  ...
  return (
    <>
      <div className="questions-shell" style={{ display: "flex", flexDirection: "column", gap: "1.25rem", maxWidth: "48rem", margin: "0 auto", width: "100%" }}>
        ...
        <div style={{ borderTop: "1px solid rgba(15,23,42,0.1)", paddingTop: "1rem" }}>
          ...
          <div className="questions-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
            <Field label="Job ID *">
        ...
        {notionUrl && <NotionLink className="questions-link" url={notionUrl} />}
